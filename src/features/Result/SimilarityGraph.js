...
const SimilarityGraph = ({ nodes, edges, onNodeHover, onEdgeHover, onEdgeClick, // ✅ props로 받기
interactionOptions, }) => {
    ...
    useEffect(() => {
        ...
        network.on('hoverEdge', (params) => {
            ...
            const matchedEdge = edges.find((e) => (e.from === fromId && e.to === toId) ||
    ...
    return _jsx("div", { ref: containerRef, style: { height: '500px', width: '100%' } });
};
