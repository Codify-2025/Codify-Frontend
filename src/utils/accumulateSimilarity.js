 ...
 */
export function accumulateSimilarityData(assignments) {
    ...
    const accumulatedNodes = Array.from(studentMap.values());
    const accumulatedEdges = Array.from(edgeMap.entries()).map(([key, { total, count }]) => {
